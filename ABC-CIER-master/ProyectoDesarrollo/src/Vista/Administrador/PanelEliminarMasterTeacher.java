 ...
 * @author oscar
 */
public class PanelEliminarMasterTeacher extends javax.swing.JPanel {

    /**
     * Creates new form PanelLogin
     */
    public PanelEliminarMasterTeacher() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonEliminarMT = new javax.swing.JButton();
        ...
        labelBuscarMaster.setText("ELIMINAR MASTER TEACHER");
        ...
        jButtonEliminarMT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonEliminarMTActionPerformed(evt);
            }
        });
    ...
    private void jButtonEliminarMTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarMTActionPerformed
        // TODO add your handling code here:
        eliminarMasterTeacher ();
        limpiarPanelDatos ();
        jButtonEliminarMT.setEnabled(false);
    }//GEN-LAST:event_jButtonEliminarMTActionPerformed
    ...
    private javax.swing.JButton jButtonEliminarMT;
    ...
    public void limpiarPanelDatos () { 
     ...
     public void mostrarInfoMasterTeacher (MasterTeacher master) {
        ...
        if (master.getIdCurso() != null) {
            jTextFieldIdCurso.setText("" + master.getIdCurso().getIdCurso());
            
            //jComboBoxIdCurso.setSelectedItem("" + master.getIdCurso().getIdCurso());
            //jComboBoxIdCurso.setSelectedItem("IC9 5");
        }
            
     }
     public void eliminarMasterTeacher () { 
         contAdministrador = ControladorAdministrador.getInstance();
        MasterTeacher master = contAdministrador.buscarMasterTeacherPorCedula(jTextFieldCedula.getText());
        
        
        String result = contAdministrador.modificarMasterTeacher(master.getCedula(),  master.getNombre(),  master.getApellido(),  master.getCorreo(), master.getCiudad(), 
                                                                master.getPais(),  false, master.getIdCurso());
         if (result.equals("1")) {
              mostarMensaje(JOptionPane.INFORMATION_MESSAGE, 
