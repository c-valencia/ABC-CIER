...
public class DaoFases implements Serializable {
    ...
    public void insertarFase(Fases fase){
        EntityManager em = null;
        try {
             em = getEntityManager();
            em.getTransaction().begin();
            Query query = em.createNativeQuery("INSERT INTO fases (id_curso, numero_horas, numero_semanas, tipo, contenido, estado) "
