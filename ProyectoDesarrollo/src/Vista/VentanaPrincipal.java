...
public class VentanaPrincipal extends JFrame {
    ...
    */
    ...
    private void panelSuperior(){
        ...
        ImageIcon img = new ImageIcon(getClass().getResource("/Vista/Image/Logo_cier-sur.jpg"));
    ...
    private void cargarLookAndFeel() {
        try {
             ...
             */
            UIManager.setLookAndFeel("javax.swing.plaf.nimbus.NimbusLookAndFeel"); // OPCION 1
            // UIManager.setLookAndFeel(WebLookAndFeel.class.getCanonicalName()); // OPCION 2
