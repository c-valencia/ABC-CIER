...
public class PanelCoordinador extends javax.swing.JPanel {
    ...
    // PANELES 
    private Panel_UpdateLT panelUpdateLT;
    ...
    private class EventosPanelCoordinador implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == itemModificar) { 
                panelUpdateLT = new Panel_UpdateLT();                       
                actualizarPaneDer(panelUpdateLT);
            }
            if (e.getSource() == itemBuscar) {    
                panelBuscarLT = new Panel_BuscarLT(); 
                actualizarPaneDer(panelBuscarLT);
            }
            if (e.getSource() == itemEliminar) {       
                panelEliminarLT = new Panel_EliminarLT();
                actualizarPaneDer(panelEliminarLT);
            }
            // Menu de Cohorte
