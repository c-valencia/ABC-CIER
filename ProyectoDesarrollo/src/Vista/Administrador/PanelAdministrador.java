...
public class PanelAdministrador extends javax.swing.JPanel {
    ...
    PanelModificarCoordinador pModificarCoordinador;
    PanelEliminarCoordinador pEliminarCoordinador;
    ...
    public void inicializarPaneles() {
        ...
        pModificarCoordinador = new PanelModificarCoordinador (); 
        pEliminarCoordinador = new PanelEliminarCoordinador ();
    ...
    private void addImage(){
        ...
        ImageIcon img = new ImageIcon(getClass().getResource("/Vista/Image/Logounivalle.png"));
    ...
    private class EventosPanelAdministrador implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == itemCrearCoor) {
                actualizarPaneDer(pCrearCoordinador);
            }
            if (e.getSource() == itemModificarCoor) {    
                actualizarPaneDer(pModificarCoordinador);
            }
            if (e.getSource() == itemBuscarCoor) {   
                actualizarPaneDer(pbuscarCoordinador);
            }
            if (e.getSource() == itemEliminarCoor) {     
                actualizarPaneDer(pEliminarCoordinador);
            }
            // Menu de Master Teacher
            if (e.getSource() == itemCrearMT) {    
                actualizarPaneDer(pCrearMasterTeacher);
                pCrearMasterTeacher.inicializarCombobox();
            }
            
            if (e.getSource() == itemModificarMT) {    
                 actualizarPaneDer(pModificarMasterTeacher);
                 pModificarMasterTeacher.inicializarCombobox();
            }
            
            if (e.getSource() == itemBuscarMT) {     
                actualizarPaneDer(pBuscarMasterTeacher);
            }
            if (e.getSource() == itemEliminarMT) { 
                actualizarPaneDer(pEliminarMasterTeacher);
            }
            // Menu Cursos
